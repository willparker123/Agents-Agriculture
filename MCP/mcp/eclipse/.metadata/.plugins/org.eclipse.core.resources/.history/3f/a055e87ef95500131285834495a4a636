...
public class ItemScrollPotato extends Item
 {
     public ItemScrollPotato(int i)
     {
         super(i);
         maxStackSize = 64;
     ...
     public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
     {
    	 ...
    	 par3EntityPlayer.addChatMessage("\2474Name: \247fPotato");
    	 ...
    	 par3EntityPlayer.addChatMessage("\247aDrops: \247f1-4 Potatoes, 2% Chance of a Poisonous Potato");
