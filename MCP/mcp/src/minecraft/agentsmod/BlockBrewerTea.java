...
public class BlockBrewerTea extends Block
{
	...
	public BlockBrewerTea(int par1, Material par2)
	{
		...
		super.updateTick(par1World, par2, par3, par4, par5Random);
			...
			float f = 1.0F;
				...
				if (par5Random.nextInt((int)(40F / f) + 1) == 0)
				{
				    ...
				    par1World.setBlock(par2, par3, par4, ModBlocks.brewerTeaDone.blockID);
	            }
	    }
