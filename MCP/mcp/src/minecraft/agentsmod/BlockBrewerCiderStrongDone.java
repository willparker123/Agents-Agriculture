...
public class BlockBrewerCiderStrongDone extends Block
{
	...
	public BlockBrewerCiderStrongDone(int par1, Material par2)
	{
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
	{
			if (par5EntityPlayer.getCurrentEquippedItem() != null && par5EntityPlayer.getCurrentEquippedItem().itemID == Item.bucketEmpty.itemID)
			{
			    ...
			    par5EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ModFood.ciderstrongBucket,1));
