...
public class ItemScrollWalnutHarder extends Item
 {
     public ItemScrollWalnutHarder(int i)
     {
         super(i);
         maxStackSize = 64;
     ...
     public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
     {
    	 ...
    	 par3EntityPlayer.addChatMessage("\2474Name: \247fIron Walnut");
    	 ...
    	 par3EntityPlayer.addChatMessage("\247aDrops: \247f4-6 Iron Walnuts");
