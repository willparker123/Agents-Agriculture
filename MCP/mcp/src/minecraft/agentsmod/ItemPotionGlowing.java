...
public class ItemPotionGlowing extends ItemFood
{
    ...
    public ItemPotionGlowing(int par1, int par2, float par3, boolean par4)
    {
    ...
    public ItemPotionGlowing(int par1, int par2, boolean par3)
    {
     ...
     */
    public ItemPotionGlowing setPotionEffect(int par1, int par2, int par3, float par4)
    {
        this.potionId = par1;
    ...
    public ItemPotionGlowing setPotionEffect2(int par1, int par2, int par3, float par4)
    {
        this.potionId2 = par1;
     ...
     */
    public ItemPotionGlowing setAlwaysEdible()
    {
