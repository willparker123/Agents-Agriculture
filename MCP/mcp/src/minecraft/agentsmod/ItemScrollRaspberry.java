...
public class ItemScrollRaspberry extends Item
 {
     public ItemScrollRaspberry(int i)
     {
         super(i);
         maxStackSize = 64;
     ...
     public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
     {
    	 ...
    	 par3EntityPlayer.addChatMessage("\2474Name: \247fRaspberry");
    	 ...
    	 par3EntityPlayer.addChatMessage("\247aDrops: \247f3-6 Raspberries");
