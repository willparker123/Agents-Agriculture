...
public class BlockDryingRackTobacco extends BlockDirectional
{
	...
	public BlockDryingRackTobacco(int par1, Material par2)
	{
...
{
    par5EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ModFruits.tobacco,4));
...
public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
{
	super.updateTick(par1World, par2, par3, par4, par5Random);
		...
		float f = 1.0F;
			...
			{
			    this.onBlockDestroyedByPlayer(par1World, par2, par3, par4, 1);
			    par1World.setBlock(par2, par3, par4, ModBlocks.rackTobaccoDry.blockID);
            }
        }
	/*/
	@SideOnly(Side.CLIENT)
...
/*/
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLivingBase, ItemStack itemstack)
	{
		...
		if (l == 1)
		{
			...
			world.setBlock(x, y, z, ModBlocks.rackTobaccob.blockID);
		}
