...
public class ItemScrollBean extends Item
 {
     public ItemScrollBean(int i)
     {
         super(i);
         maxStackSize = 64;
     ...
     public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
     {
    	 ...
    	 par3EntityPlayer.addChatMessage("\2474Name: \247fBean");
    	 ...
    	 par3EntityPlayer.addChatMessage("\247aDrops: \247f4 Bean Pods");
    	 ...
    	 par3EntityPlayer.addChatMessage("Can be right-clicked for it's Fruit. Has to be made with DNA");
    	 par3EntityPlayer.addChatMessage("\247l********************");
    	 }
