...
public class EntityWalnutShellWB extends EntityThrowable
{
    public int field_92057_e = 500;
    
    public EntityWalnutShellWB(World par1World)
    {
        super(par1World);
    ...
    public EntityWalnutShellWB(World par1World, EntityPlayer par3EntityPlayer)
    {
        super(par1World, par3EntityPlayer);
    }

    public EntityWalnutShellWB(World par1World, double par2, double par4, double par6)
    {
