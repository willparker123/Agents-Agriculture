...
public class BlockCropBean2 extends BlockCrops
{
	@SideOnly(Side.CLIENT)
	private Icon[] iconArray;
	private Random par1Random;

	protected BlockCropBean2(int par1)
	{
		super(par1);
	...
	{
		return par1 == Block.grass.blockID || par1 == Block.dirt.blockID || par1 == Block.tilledField.blockID || par1 == ModCrops.beanCrop.blockID || par1 == ModCrops.beanCropb.blockID || par1 == ModCrops.beanCropc.blockID || par1 == ModCrops.beanCropd.blockID;
	}
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
	{
		...
		{
			par5EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ModFruits.beanPod,2));
	 ...
	 protected int getCropItem()
	{
	 ...
	 public void registerIcons(IconRegister par1IconRegister)
	 {
		 ...
		 {
			 this.iconArray[i] = par1IconRegister.registerIcon(ModCrops.modid + ":" + "beanCrop" + i);
		 }
	 }
	...
	/*/
	 ...
	 public ArrayList<ItemStack> getBlockDropped(World world, int x, int y, int z, int metadata, int fortune)
	 {
		 ...
		 if (metadata > 5)
		 {
			 ret.add(new ItemStack(ModFruits.beanPod, 4));
		 }
