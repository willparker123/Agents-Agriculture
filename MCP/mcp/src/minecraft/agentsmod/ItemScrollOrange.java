...
public class ItemScrollOrange extends Item
 {
     public ItemScrollOrange(int i)
     {
         super(i);
         maxStackSize = 64;
     ...
     public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
     {
    	 ...
    	 par3EntityPlayer.addChatMessage("\2474Name: \247fOrange");
    	 ...
    	 par3EntityPlayer.addChatMessage("\247aDrops: \247f1 Orange Sapling");
    	 par3EntityPlayer.addChatMessage("\247aGrows On: \247fTilled Dirt");
    	 par3EntityPlayer.addChatMessage("\247aGrowth Rate: \247fSlow");
    	 par3EntityPlayer.addChatMessage("Orange Trees can be found in Plains and Forests");
    	 par3EntityPlayer.addChatMessage("\247l********************");
    	 }
