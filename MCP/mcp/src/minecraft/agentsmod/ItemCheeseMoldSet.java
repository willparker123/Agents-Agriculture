...
public class ItemCheeseMoldSet extends Item
{
    /** The ID of the block the reed will spawn when used from inventory bar. */
    private int spawnID;

    public ItemCheeseMoldSet(int par1)
    {
        super(par1);
    }
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int x, int y, int z, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
        	...
        	{
        		par3World.setBlock(x, y + 1, z, ModBlocks.cheesemoldSet.blockID);
        		par3World.notifyBlockOfNeighborChange(x, y, z, ModBlocks.cheesemoldSet.blockID);
