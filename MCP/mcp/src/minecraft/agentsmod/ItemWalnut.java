...
public class ItemWalnut extends ItemSeedFood implements IPlantable
{
    ...
    public ItemWalnut(int par1, int par2, float par3, int par4, int par5)
    {
    ...
    public ItemStack onEaten(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        if (par3EntityPlayer.getCurrentEquippedItem() != null && par3EntityPlayer.getCurrentEquippedItem().itemID == ModFruits.walnutGold.itemID)
        {
        	par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ModFruits.walnutshellGold,1));
        }
        if (par3EntityPlayer.getCurrentEquippedItem() != null && par3EntityPlayer.getCurrentEquippedItem().itemID == ModFruits.walnutDiamond.itemID)
        {
        	par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ModFruits.walnutshellDiamond,1));
        }
