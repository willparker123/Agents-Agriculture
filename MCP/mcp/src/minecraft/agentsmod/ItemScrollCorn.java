...
public class ItemScrollCorn extends Item
 {
     public ItemScrollCorn(int i)
     {
         super(i);
         maxStackSize = 64;
     ...
     public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
     {
    	 ...
    	 par3EntityPlayer.addChatMessage("\2474Name: \247fCorn");
    	 par3EntityPlayer.addChatMessage("\247aHeight: \247f3 Blocks");
    	 ...
    	 par3EntityPlayer.addChatMessage("\247aDrops: \247f3-6 Corn Cobs");
    	 ...
    	 par3EntityPlayer.addChatMessage("Can be right-clicked for it's Fruit. Found in Swamps");
    	 par3EntityPlayer.addChatMessage("\247l********************");
    	 }
