...
public class ItemDrinkGlowing extends ItemFood
{
    ...
    public ItemDrinkGlowing(int par1, int par2, float par3, boolean par4)
    {
    ...
    public ItemDrinkGlowing(int par1, int par2, boolean par3)
    {
    ...
    public ItemStack onEaten(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        if (par3EntityPlayer.getCurrentEquippedItem() != null && par3EntityPlayer.getCurrentEquippedItem().itemID == ModTools.potionvenomStrong.itemID)
        {
        ...
        par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ModFood.cup,1));
     ...
     */
    public ItemDrinkGlowing setPotionEffect(int par1, int par2, int par3, float par4)
    {
        this.potionId = par1;
    ...
    public ItemDrinkGlowing setPotionEffect2(int par1, int par2, int par3, float par4)
    {
        this.potionId2 = par1;
     ...
     */
    public ItemDrinkGlowing setAlwaysEdible()
    {
