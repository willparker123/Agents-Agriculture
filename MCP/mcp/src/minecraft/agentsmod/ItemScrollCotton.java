...
public class ItemScrollCotton extends Item
 {
     public ItemScrollCotton(int i)
     {
         super(i);
         maxStackSize = 64;
     ...
     public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
     {
    	 ...
    	 par3EntityPlayer.addChatMessage("\2474Name: \247fCotton");
    	 ...
    	 par3EntityPlayer.addChatMessage("\247aDrops: \247f2-3 Cotton");
    	 par3EntityPlayer.addChatMessage("\247aGrows On: \247fTilled Dirt");
    	 par3EntityPlayer.addChatMessage("\247aGrowth Rate: \247fFast");
    	 par3EntityPlayer.addChatMessage("Can be right-clicked for it's Fruit. Found in Plains and on River Banks");
    	 par3EntityPlayer.addChatMessage("\247l********************");
    	 }
