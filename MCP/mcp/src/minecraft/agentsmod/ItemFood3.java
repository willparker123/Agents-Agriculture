...
public class ItemFood3 extends ItemFood
{
    ...
    public ItemFood3(int par1, int par2, float par3, boolean par4)
    {
    ...
    public ItemFood3(int par1, int par2, boolean par3)
    {
     ...
     */
    public ItemFood3 setPotionEffect(int par1, int par2, int par3, float par4)
    {
        this.potionId = par1;
    ...
    public ItemFood3 setPotionEffect2(int par1, int par2, int par3, float par4)
    {
        this.potionId2 = par1;
     ...
     */
    public ItemFood3 setAlwaysEdible()
    {
