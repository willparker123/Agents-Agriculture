...
public class ItemScrollWeed extends Item
 {
     public ItemScrollWeed(int i)
     {
         super(i);
         maxStackSize = 64;
     ...
     public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
     {
    	 if(par2World.isRemote)
    	 {
        	 ...
        	 par3EntityPlayer.addChatMessage("\2474Name: \247fCannabis");
        	 par3EntityPlayer.addChatMessage("\247aHeight: \247f1 Block");
        	 par3EntityPlayer.addChatMessage("\247aLight Level: \247f15 and Over");
        	 par3EntityPlayer.addChatMessage("\247aStages: \247f7");
        	 par3EntityPlayer.addChatMessage("\247aDrops: \247f3-6 Cannabis Leaves");
