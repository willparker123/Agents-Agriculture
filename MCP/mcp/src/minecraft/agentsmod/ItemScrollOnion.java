...
public class ItemScrollOnion extends Item
 {
     public ItemScrollOnion(int i)
     {
         super(i);
         maxStackSize = 64;
     ...
     public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
     {
    	 ...
    	 par3EntityPlayer.addChatMessage("\2474Name: \247fOnion");
    	 par3EntityPlayer.addChatMessage("\247aHeight: \247f1 Block");
    	 par3EntityPlayer.addChatMessage("\247aLight Level: \247fOver 12");
    	 par3EntityPlayer.addChatMessage("\247aStages: \247f5");
    	 par3EntityPlayer.addChatMessage("\247aDrops: \247f2-3 Onions");
    	 ...
    	 par3EntityPlayer.addChatMessage("Found in Swamps and Forests");
    	 par3EntityPlayer.addChatMessage("\247l********************");
    	 }
