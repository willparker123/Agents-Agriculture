...
public class ModelWhale extends ModelBase
{
  //fields
    ...
    protected float field_78145_g = 0.2F;
    protected float field_78151_h = 0.2F;
  ...
  public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity)
  {
      ...
      this.BackFin1.rotateAngleX = MathHelper.cos(par1 * 0.8F) * 0.3F * par2;
      /*/
	  
	  //this.Tail1.rotateAngleX = MathHelper.cos(par1 * 0.6662F) * 1.4F * par2;
	  //this.Tail2.rotateAngleX = MathHelper.cos(par1 * 0.6662F) * 1.4F * par2;
	  //this.Tail3.rotateAngleX = MathHelper.cos(par1 * 0.6662F) * 1.4F * par2;
	  //this.Tail4.rotateAngleX = MathHelper.cos(par1 * 0.6662F) * 1.4F * par2;
	  //this.BackFin1.rotateAngleX = MathHelper.cos(par1 * 0.6662F) * 1.4F * par2;
