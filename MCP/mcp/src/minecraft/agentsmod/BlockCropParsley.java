...
public class BlockCropParsley extends BlockCrops
{
	...
	protected BlockCropParsley(int par1)
	{
		super(par1);
	...
	public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
	{
		...
		if (par1World.getBlockLightValue(par2, par3 + 1, par4) >= 11)
		{
	...
	public int idDropped(int par1, Random par2Random, int par3)
    {
        if (par1 >= 5)
        {
            return ModCrops.parsleyPlant.blockID;
        }
        else
        {
            return 0;
...
public int quantityDropped(Random par1Random)
{
	...
	{
		return ModFruits.parsleySeed.itemID;
	}
