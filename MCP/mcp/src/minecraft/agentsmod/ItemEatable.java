...
public class ItemEatable extends ItemFood
{
    ...
    public ItemEatable(int par1, int par2, float par3, boolean par4)
    {
    ...
    public ItemEatable(int par1, int par2, boolean par3)
    {
     ...
     */
    public ItemEatable setPotionEffect(int par1, int par2, int par3, float par4)
    {
        this.potionId = par1;
    ...
    public ItemEatable setPotionEffect2(int par1, int par2, int par3, float par4)
    {
        this.potionId2 = par1;
