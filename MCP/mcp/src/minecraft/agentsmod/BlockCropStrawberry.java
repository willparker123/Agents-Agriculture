...
public class BlockCropStrawberry extends BlockCrops
{
	...
	protected BlockCropStrawberry(int par1)
	{
		super(par1);
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
	{
		...
		{
			par5EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ModFruits.strawberry,2));
	...
	public int idDropped(int par1, Random par2Random, int par3)
    {
        if (par1 >= 6)
        {
            return ModFruits.strawberry.itemID;
        }
        else
        {
            return 0;
...
public int quantityDropped(Random par1Random)
{
	...
	{
		return ModFruits.strawberrySeed.itemID;
	}
