...
public class ItemScrollBRaspberry extends Item
 {
     public ItemScrollBRaspberry(int i)
     {
         super(i);
         maxStackSize = 64;
     ...
     public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
     {
    	 ...
    	 par3EntityPlayer.addChatMessage("\2474Name: \247fBlue Raspberry");
    	 ...
    	 par3EntityPlayer.addChatMessage("\247aDrops: \247f3-6 Blue Raspberries");
