...
public class BlockCropGrapePurple4 extends BlockCrops
{
    @SideOnly(Side.CLIENT)
    private Icon[] iconArray;
	private Random par1Random;
    
	protected BlockCropGrapePurple4(int par1)
	{
		super(par1);
    ...
    {
        return par1 == Block.grass.blockID || par1 == Block.dirt.blockID || par1 == Block.tilledField.blockID || par1 == ModCrops.grapePurpleCrop.blockID || par1 == ModCrops.grapePurpleCropb.blockID || par1 == ModCrops.grapePurpleCropc.blockID || par1 == ModCrops.grapePurpleCropd.blockID;
    }
	 ...
	 public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
		{
			...
			{
				par5EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ModFruits.grapePurple,3));
	...
	public void fertilize(World par1World, int par2, int par3, int par4)
    {
	 ...
	 @SideOnly(Side.CLIENT)
	    ...
	    public void registerIcons(IconRegister par1IconRegister)
	    {
	        ...
	        {
	            this.iconArray[i] = par1IconRegister.registerIcon(ModCrops.modid + ":" + "grapePurpleCrop" + i);
	        }
	    }
...
public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
{
   ...
   for (int j = 0; j < i; j++)
   {
       if (par1World.rand.nextInt(5) == 0)
       {
           ...
           EntityItem entityitem = new EntityItem(par1World, (float)par2 + f1, (float)par3 + f2, (float)par4 + f3, new ItemStack(ModFruits.grapePurpleSeed));
...
public AxisAlignedBB getCollisionBoundingBoxFromPool(World par1World, int par2, int par3, int par4)
{
    ...
    public ArrayList<ItemStack> getBlockDropped(World world, int x, int y, int z, int metadata, int fortune)
    {
        ArrayList<ItemStack> ret = super.getBlockDropped(world, x, y, z, metadata, fortune);
                ...
                if (metadata > 5)
                {
                    ret.add(new ItemStack(ModFruits.grapePurple, 4));
                }
