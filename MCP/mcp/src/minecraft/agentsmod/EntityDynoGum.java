...
public class EntityDynoGum extends EntityThrowable
{
    private int explosionRadius = 2;
    
    public EntityDynoGum(World par1World)
    {
        super(par1World);
    ...
    public EntityDynoGum(World par1World, EntityPlayer par3EntityPlayer)
    {
        super(par1World, par3EntityPlayer);
    }

    public EntityDynoGum(World par1World, double par2, double par4, double par6)
    {
