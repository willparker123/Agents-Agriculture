...
public class ItemDrink2 extends ItemFood
{
    ...
    public ItemDrink2(int par1, int par2, float par3, boolean par4)
    {
    ...
    public ItemDrink2(int par1, int par2, boolean par3)
    {
    ...
    public ItemStack onEaten(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ModFood.jar,1));
     ...
     */
    public ItemDrink2 setPotionEffect(int par1, int par2, int par3, float par4)
    {
        this.potionId = par1;
    ...
    public ItemDrink2 setPotionEffect2(int par1, int par2, int par3, float par4)
    {
        this.potionId2 = par1;
     ...
     */
    public ItemDrink2 setAlwaysEdible()
    {
