...
public class ItemDrinkBucketGlowing extends ItemFood
{
    ...
    public ItemDrinkBucketGlowing(int par1, int par2, float par3, boolean par4)
    {
    ...
    public ItemDrinkBucketGlowing(int par1, int par2, boolean par3)
    {
    ...
    protected void onFoodEaten(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        if (par3EntityPlayer.getCurrentEquippedItem() != null && par3EntityPlayer.getCurrentEquippedItem().itemID == ModFood.vodkabasicBucket.itemID)
		{
        	par3EntityPlayer.addStat(ModFood.russianAchieve, 1);
			return;
		}
    }
     ...
     */
    public ItemDrinkBucketGlowing setPotionEffect(int par1, int par2, int par3, float par4)
    {
        this.potionId = par1;
    ...
    public ItemDrinkBucketGlowing setPotionEffect2(int par1, int par2, int par3, float par4)
    {
        this.potionId2 = par1;
    ...
    public ItemDrinkBucketGlowing setPotionEffect3(int par1, int par2, int par3, float par4)
    {
        this.potionId3 = par1;
    ...
    public ItemDrinkBucketGlowing setPotionEffect4(int par1, int par2, int par3, float par4)
    {
        this.potionId4 = par1;
    ...
    public ItemDrinkBucketGlowing setPotionEffect5(int par1, int par2, int par3, float par4)
    {
        this.potionId5 = par1;
    ...
    public ItemDrinkBucketGlowing setPotionEffect6(int par1, int par2, int par3, float par4)
    {
        this.potionId6 = par1;
     ...
     */
    public ItemDrinkBucketGlowing setAlwaysEdible()
    {
