...
public class ItemScrollGarlic extends Item
 {
     public ItemScrollGarlic(int i)
     {
         super(i);
         maxStackSize = 64;
     ...
     public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
     {
    	 ...
    	 par3EntityPlayer.addChatMessage("\2474Name: \247fGarlic");
    	 ...
    	 par3EntityPlayer.addChatMessage("\247aDrops: \247f2-3 Garlic");
