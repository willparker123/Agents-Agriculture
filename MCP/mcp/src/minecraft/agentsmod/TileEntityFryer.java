...
public class TileEntityFryer extends TileEntity implements ISidedInventory
{
	...
	{
		return this.isInvNameLocalized() ? this.localisedName : "Fryer";
	}
	...
	public void updateEntity()
	{
		...
		if(!this.worldObj.isRemote)
		{
			...
			{
				flag1 = true;
				BlockFryer.updateFryerBlockState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
			}
		}
	...
	private boolean canSmelt()
	{
		...
		{
			ItemStack itemstack = FryerRecipes.smelting().getSmeltingResult(this.slots[0]);
	...
	private static int getItemBurnTime(ItemStack itemstack)
	{
		...
		else
		{
			...
			if (i == ModTools.oilseed.itemID) return 350; //ticks it burns for
			if (i == ModTools.oilolive.itemID) return 450; //ticks it burns for
			if (i == ModTools.oilwhale.itemID) return 1650; //ticks it burns for
			if (i == ModTools.oilfish.itemID) return 850; //ticks it burns for
