...
public class ItemDrinkBucket extends ItemFood
{
    ...
    public ItemDrinkBucket(int par1, int par2, float par3, boolean par4)
    {
		super(par1, par2, par3, par4);
        this.itemUseDuration = 40;
    ...
    public ItemDrinkBucket(int par1, int par2, boolean par3)
    {
    ...
    public ItemStack onEaten(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        if (par3EntityPlayer.getCurrentEquippedItem() != null && par3EntityPlayer.getCurrentEquippedItem().itemID == ModFood.beerbasicBucket.itemID)
        {
        	par3EntityPlayer.heal(6);
        }
        
        if (par3EntityPlayer.getCurrentEquippedItem() != null && par3EntityPlayer.getCurrentEquippedItem().itemID == ModFood.winebasicBucket.itemID)
        {
        	par3EntityPlayer.heal(8);
        }
        
        if (par3EntityPlayer.getCurrentEquippedItem() != null && par3EntityPlayer.getCurrentEquippedItem().itemID == ModFood.winestrongBucket.itemID)
        {
        	par3EntityPlayer.heal(16);
        }
        
        if (par3EntityPlayer.getCurrentEquippedItem() != null && par3EntityPlayer.getCurrentEquippedItem().itemID == ModFood.wineredBucket.itemID)
        {
        	par3EntityPlayer.heal(10);
        }
        
        if (par3EntityPlayer.getCurrentEquippedItem() != null && par3EntityPlayer.getCurrentEquippedItem().itemID == ModFood.winewhiteBucket.itemID)
        {
        	par3EntityPlayer.heal(10);
        }
        
        if (par3EntityPlayer.getCurrentEquippedItem() != null && par3EntityPlayer.getCurrentEquippedItem().itemID == ModFood.winewhitestrongBucket.itemID)
        {
        	par3EntityPlayer.heal(18);
        }
        
        if (par3EntityPlayer.getCurrentEquippedItem() != null && par3EntityPlayer.getCurrentEquippedItem().itemID == ModFood.wineredstrongBucket.itemID)
        {
        	par3EntityPlayer.heal(18);
        }
 
  
        par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(Item.bucketEmpty,1));
    ...
    public ItemDrinkBucket setPotionEffect2(int par1, int par2, int par3, float par4)
    {
        this.potionId2 = par1;
    ...
    public ItemDrinkBucket setPotionEffect3(int par1, int par2, int par3, float par4)
    {
        this.potionId3 = par1;
    ...
    public ItemDrinkBucket setPotionEffect4(int par1, int par2, int par3, float par4)
    {
        this.potionId4 = par1;
    ...
    public ItemDrinkBucket setPotionEffect5(int par1, int par2, int par3, float par4)
    {
        this.potionId5 = par1;
    ...
    public ItemDrinkBucket setPotionEffect6(int par1, int par2, int par3, float par4)
    {
        this.potionId6 = par1;
