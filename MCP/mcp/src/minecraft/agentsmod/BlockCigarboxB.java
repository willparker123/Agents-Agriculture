...
public class BlockCigarboxB extends Block
{
    ...
    protected BlockCigarboxB(int par1, Material wood)
    {
    ...
    {
    	this.setBlockBounds(0.125F, 0.0F, 0.1875F, 0.875F, 0.5F, 0.8125F);//0F 0F 0F Width Height Length
    }
    ...
    {
        return par1 == 1 ? this.blockTop : par1 == 0 ? this.blockBottom : par1 == 3 ? this.blockFront : par1 == 2 ? this.blockBack : this.blockIcon;
    }
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
		if (par5EntityPlayer.getCurrentEquippedItem() != null && par5EntityPlayer.getCurrentEquippedItem().itemID == ModFruits.tobaccoCigar.itemID)
		{
			...
			par1World.setBlock(par2, par3, par4, ModBlocks.cigarbox2b.blockID);
			return false;
		}
		...
		else
		{
			...
			//this.onBlockDestroyedByPlayer(par1World, par2, par3, par4, 1);
			//par1World.setBlock(par2, par3, par4, ModBlocks.cigarboxb.blockID);
    ...
    {
        return ModBlocks.cigarbox.blockID;
    }
