...
public class BlockCropTea extends BlockCrops
{
    @SideOnly(Side.CLIENT)
    private Icon[] iconArray;
    
	protected BlockCropTea(int par1)
	{
		super(par1);
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
	{
		...
		{
			par5EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ModFruits.tea,4));
		...
		if (par1World.getBlockLightValue(par2, par3 + 1, par4) >= 10)
		{
			...
			if (i < 5)
			{
				float f = getGrowthRate(par1World, par2, par3, par4);
	               ...
	               if (par5Random.nextInt((int)(90000 / f) + 1) == 0)
				{
                    i++;
...
public int quantityDropped(Random par1Random)
{
	...
	{
		return ModFruits.teaSeed.itemID;
	}
