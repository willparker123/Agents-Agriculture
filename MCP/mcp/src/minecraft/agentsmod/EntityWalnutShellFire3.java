...
public class EntityWalnutShellFire3 extends EntityThrowable
{
	public EntityWalnutShellFire3(World par1World)
	{
		super(par1World);
		//"/mods/ModFruits/textures/items/walnutshell.png"
	}

	public EntityWalnutShellFire3(World par1World, EntityPlayer par3EntityPlayer)
	{
		super(par1World, par3EntityPlayer);
	}

	public EntityWalnutShellFire3(World par1World, double par2, double par4, double par6)
	{
