...
public class ItemJoint extends ItemFood
{
	...
	public ItemJoint(int par1, int par2, float par3, boolean par4)
	{
	...
	public ItemJoint(int par1, int par2, boolean par3)
	{
	...
	public ItemStack onEaten(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
	{
		...
		par2World.playSoundAtEntity(par3EntityPlayer, "mob.blaze.breathe", 0.5F, par2World.rand.nextFloat() * 0.1F + 0.9F);
    ...
    protected void onFoodEaten(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        if (par3EntityPlayer.getCurrentEquippedItem() != null && par3EntityPlayer.getCurrentEquippedItem().itemID == ModFruits.weedLitJoint.itemID)
		{
        	par3EntityPlayer.addStat(ModFruits.weedAchieve, 1);
			return;
		}
    }
	...
	public ItemJoint setPotionEffect(int par1, int par2, int par3, float par4)
	{
		this.potionId = par1;
	...
	public ItemJoint setPotionEffect2(int par1, int par2, int par3, float par4)
	{
		this.potionId2 = par1;
	...
	public ItemJoint setPotionEffect3(int par1, int par2, int par3, float par4)
	{
		this.potionId3 = par1;
	...
	public ItemJoint setPotionEffect4(int par1, int par2, int par3, float par4)
	{
		this.potionId4 = par1;
	...
	public ItemJoint setPotionEffect5(int par1, int par2, int par3, float par4)
	{
		this.potionId5 = par1;
	...
	public ItemJoint setPotionEffect6(int par1, int par2, int par3, float par4)
	{
		this.potionId6 = par1;
