...
public class BlockCropPeppers extends BlockCrops
 {
    @SideOnly(Side.CLIENT)
    private Icon[] iconArray;
    
	protected BlockCropPeppers(int par1)
    {
        super(par1);
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
	{
		...
		{
			par5EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ModFruits.pepperRed,3));
		    this.onBlockDestroyedByPlayer(par1World, par2, par3, par4, 1);
		    par1World.setBlockMetadataWithNotify(par2, par3, par4, 5, 2);
		}
		if ((par1World.getBlockMetadata(par2, par3, par4) == 12))
		{
			par5EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ModFruits.pepperYellow,3));
		    this.onBlockDestroyedByPlayer(par1World, par2, par3, par4, 1);
		    par1World.setBlockMetadataWithNotify(par2, par3, par4, 5, 2);
		}
		...
		if ((par1World.getBlockMetadata(par2, par3, par4) == 9))
		{
			par5EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ModFruits.pepperGreen,3));
		    this.onBlockDestroyedByPlayer(par1World, par2, par3, par4, 1);
		    par1World.setBlockMetadataWithNotify(par2, par3, par4, 5, 2);
		}
    ...
    {
        int l = par1World.getBlockMetadata(par2, par3, par4) + MathHelper.getRandomIntegerInRange(par1World.rand, 1, 3);
	...
	public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random, int par6, float par13, float par8, float par9)
    {
           ...
           if (i < 13)
            {
                ...
                if (par5Random.nextInt((int)(25 / f) + 1) == 0)
                {
                    i++;
	...
	public int idDropped(int par1, Random par2Random, int par3)
    {
        ...
        if (par1 == 10)
        {
            return ModFruits.pepperYellow.itemID;
        }
        if (par1 == 11)
        {
            return ModFruits.pepperYellow.itemID;
        ...
        if (par1 >= 13)
        {
            return ModFruits.pepperRed.itemID;
        }
        else
        {
            return 0;
...
public int quantityDropped(Random par1Random)
{
    ...
    {
        return ModFruits.peppersSeed.itemID;
    }
