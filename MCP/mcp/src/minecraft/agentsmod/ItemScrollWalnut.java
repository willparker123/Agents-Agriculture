...
public class ItemScrollWalnut extends Item
 {
     public ItemScrollWalnut(int i)
     {
         super(i);
         maxStackSize = 64;
     ...
     public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
     {
    	 ...
    	 par3EntityPlayer.addChatMessage("\2474Name: \247fWalnut");
    	 ...
    	 par3EntityPlayer.addChatMessage("\247aDrops: \247f3-7 Walnuts");
    	 par3EntityPlayer.addChatMessage("\247aGrows On: \247fTilled Dirt");
    	 par3EntityPlayer.addChatMessage("\247aGrowth Rate: \247fExtremely Slow");
    	 par3EntityPlayer.addChatMessage("Can be right-clicked for it's Fruit. Found in Jungles");
    	 par3EntityPlayer.addChatMessage("\247l********************");
    	 }
