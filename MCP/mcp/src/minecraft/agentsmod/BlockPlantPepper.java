...
public class BlockPlantPepper extends BlockFlower
{
public BlockPlantPepper(int par1, Material par2)
{
	...
	for (int j = 0; j < i; j++)
		...
		if (par1World.rand.nextInt(2) == 0)
			...
			float f3 = par1World.rand.nextFloat() * f + (1.0F - f) * 0.5F;
			 EntityItem entityitem = new EntityItem(par1World, (float)par2 + f1, (float)par3 + f2, (float)par4 + f3, new ItemStack(ModFruits.pepperSeed));
