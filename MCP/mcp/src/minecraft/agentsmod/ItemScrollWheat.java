...
public class ItemScrollWheat extends Item
 {
     public ItemScrollWheat(int i)
     {
         super(i);
         maxStackSize = 64;
     ...
     public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
     {
    	 ...
    	 par3EntityPlayer.addChatMessage("\2474Name: \247fWheat");
    	 ...
    	 par3EntityPlayer.addChatMessage("\247aDrops: \247f1 Wheat");
    	 ...
    	 par3EntityPlayer.addChatMessage("A Vanilla crop that can be used to breed Cows and Sheep. Can also be used to tame Horses.");
    	 par3EntityPlayer.addChatMessage("\247l********************");
    	 }
