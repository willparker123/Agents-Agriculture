...
public class BlockDryingRackPigskin extends BlockDirectional
{
	@SideOnly(Side.CLIENT)
	private Icon blockFront;

	public BlockDryingRackPigskin(int par1, Material par2)
	{
...
/*/
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLivingBase, ItemStack itemstack)
	{
		...
		if (l == 1)
		{
			...
			world.setBlock(x, y, z, ModBlocks.rackPigskinb.blockID);
		}
