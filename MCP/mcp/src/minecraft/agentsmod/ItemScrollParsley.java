...
public class ItemScrollParsley extends Item
 {
     public ItemScrollParsley(int i)
     {
         super(i);
         maxStackSize = 64;
     ...
     public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
     {
    	 ...
    	 par3EntityPlayer.addChatMessage("\2474Name: \247fParsley");
    	 ...
    	 par3EntityPlayer.addChatMessage("\247aDrops: \247f1-3 Parsley");
