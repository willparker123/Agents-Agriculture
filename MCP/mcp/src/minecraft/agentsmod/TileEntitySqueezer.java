...
public class TileEntitySqueezer extends TileEntity implements ISidedInventory
{
	...
	public int furnaceSpeed = 2000; //how many ticks to cook an item
	public int burnTime;
	...
	{
		return this.isInvNameLocalized() ? this.localisedName : "Squeezer";
	}
	...
	public void updateEntity()
	{
		...
		if(!this.worldObj.isRemote)
		{
			...
			{
				flag1 = true;
				BlockSqueezer.updateSqueezerBlockState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
			}
		}
	...
	private boolean canSmelt()
	{
		...
		{
			ItemStack itemstack = SqueezerRecipes.smelting().getSmeltingResult(this.slots[0]);
	...
	private static int getItemBurnTime(ItemStack itemstack)
	{
			...
			else
			{
				...
				if (i == Item.glassBottle.itemID) return 2000; //ticks it burns for
