...
public class BlockCropBlackcurrant extends BlockCrops
{
    @SideOnly(Side.CLIENT)
    private Icon[] iconArray;
    
	protected BlockCropBlackcurrant(int par1)
	{
		super(par1);
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
	{
		...
		{
			par5EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ModFruits.blackcurrant,4));
	...
	public int idDropped(int par1, Random par2Random, int par3)
    {
        if (par1 >= 6)
        {
            return ModFruits.blackcurrant.itemID;
        }
        else
        {
            return 0;
...
{
	return 3 + par1Random.nextInt(8);
}

	public int idPicked(World par1World, int par2, int par3, int par4)
	{
		return ModFruits.blackcurrantSeed.itemID;
	}
