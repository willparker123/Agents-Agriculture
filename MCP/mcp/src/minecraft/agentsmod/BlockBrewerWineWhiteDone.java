...
public class BlockBrewerWineWhiteDone extends Block
{
	...
	public BlockBrewerWineWhiteDone(int par1, Material par2)
	{
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
	{
			if (par5EntityPlayer.getCurrentEquippedItem() != null && par5EntityPlayer.getCurrentEquippedItem().itemID == Item.bucketEmpty.itemID)
			{
			    ...
			    par5EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ModFood.winewhiteBucket,1));
	...
	public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
	{
		...
		if (par1World.getBlockLightValue(par2, par3 + 1, par4) <= 10)
		{
			float f = 1.0F;
				...
				{
				    this.onBlockDestroyedByPlayer(par1World, par2, par3, par4, 1);
				    par1World.setBlock(par2, par3, par4, ModBlocks.brewerWineWhiteStrongDone.blockID);
	            }
	        }
	    }
