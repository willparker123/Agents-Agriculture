...
public class BlockDryingRackTea extends BlockDirectional
{
	...
	public BlockDryingRackTea(int par1, Material par2)
	{
...
public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
{
	super.updateTick(par1World, par2, par3, par4, par5Random);
		...
		float f = 1.0F;
			...
			if (par5Random.nextInt((int)(60F / f) + 1) == 0)
			{
			    this.onBlockDestroyedByPlayer(par1World, par2, par3, par4, 1);
			    par1World.setBlock(par2, par3, par4, ModBlocks.rackTeaDry.blockID);
            }
        }
	/*/
	@SideOnly(Side.CLIENT)
...
/*/
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLivingBase, ItemStack itemstack)
	{
		...
		if (l == 1)
		{
			...
			world.setBlock(x, y, z, ModBlocks.rackTeab.blockID);
		}
