...
public class BlockLemonLeaves2 extends BlockLeavesBase implements IShearable
{
    ...
    protected BlockLemonLeaves2(int par1)
    {
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
		...
		if (par1World.getBlockLightValue(par2, par3 + 1, par4) >= 8)
		{
				float f = getGrowthRate(par1World, par2, par3, par4);
	               ...
	               if (par5Random.nextInt((int)(350 / f) + 1) == 0)
				{
					this.onBlockDestroyedByPlayer(par1World, par2, par3, par4, 1);
				    par1World.setBlock(par2, par3, par4, ModCrops.lemonLeaves3.blockID);
				}
			}
