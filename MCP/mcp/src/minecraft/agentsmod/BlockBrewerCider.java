...
public class BlockBrewerCider extends Block
{
	...
	public BlockBrewerCider(int par1, Material par2)
	{
		...
		if (par1World.getBlockLightValue(par2, par3 + 1, par4) <= 10)
		{
			float f = 1.0F;
				...
				if (par5Random.nextInt((int)(180F / f) + 1) == 0)
				{
				    ...
				    par1World.setBlock(par2, par3, par4, ModBlocks.brewerCiderDone.blockID);
	            }
	        }
	    }
