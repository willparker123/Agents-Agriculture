...
public class ItemBeer extends ItemFood
{
     ...
     */
    public ItemBeer setPotionEffect(int par1, int par2, int par3, float par4)
    {
        this.potionId = par1;
    ...
    public ItemBeer setPotionEffect2(int par1, int par2, int par3, float par4)
    {
        this.potionId2 = par1;
    ...
    public ItemBeer setPotionEffect3(int par1, int par2, int par3, float par4)
    {
        this.potionId3 = par1;
    ...
    public ItemBeer setPotionEffect4(int par1, int par2, int par3, float par4)
    {
        this.potionId4 = par1;
    ...
    public ItemBeer setPotionEffect5(int par1, int par2, int par3, float par4)
    {
        this.potionId5 = par1;
    ...
    public ItemBeer setPotionEffect6(int par1, int par2, int par3, float par4)
    {
        this.potionId6 = par1;
     ...
     */
    public ItemBeer setAlwaysEdible()
    {
