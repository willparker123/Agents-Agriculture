...
public final class TabOther extends CreativeTabs
{
        public TabOther(int par1, String par2Str)
        {
                super(par1, par2Str);
        }
        ...
        public int getTabIconItemIndex()
        {
           //there is a diference between items and blocks. will give an example of both
                return ModTools.scorpiontail.itemID;//items
        ...
        {
         return "\2472(Agent's Agriculture) Other Items";
        }
}
