...
public class BlockFermenterSpiderEyeDone extends Block
{
	...
	public BlockFermenterSpiderEyeDone(int par1, Material par2)
	{
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
	{
		    ...
		    par5EntityPlayer.inventory.addItemStackToInventory(new ItemStack(Item.fermentedSpiderEye,1));
