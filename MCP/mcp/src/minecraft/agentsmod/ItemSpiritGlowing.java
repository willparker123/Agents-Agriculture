...
public class ItemSpiritGlowing extends ItemFood
{
    ...
    public ItemSpiritGlowing(int par1, int par2, float par3, boolean par4)
    {
    ...
    public ItemSpiritGlowing(int par1, int par2, boolean par3)
    {
    ...
    public ItemStack onEaten(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        if (par3EntityPlayer.getCurrentEquippedItem() != null && par3EntityPlayer.getCurrentEquippedItem().itemID == ModFood.vodkabasic.itemID)
        {
     ...
     */
    public ItemSpiritGlowing setPotionEffect(int par1, int par2, int par3, float par4)
    {
        this.potionId = par1;
    ...
    public ItemSpiritGlowing setPotionEffect2(int par1, int par2, int par3, float par4)
    {
        this.potionId2 = par1;
    ...
    public ItemSpiritGlowing setPotionEffect3(int par1, int par2, int par3, float par4)
    {
        this.potionId3 = par1;
    ...
    public ItemSpiritGlowing setPotionEffect4(int par1, int par2, int par3, float par4)
    {
        this.potionId4 = par1;
    ...
    public ItemSpiritGlowing setPotionEffect5(int par1, int par2, int par3, float par4)
    {
        this.potionId5 = par1;
    ...
    public ItemSpiritGlowing setPotionEffect6(int par1, int par2, int par3, float par4)
    {
        this.potionId6 = par1;
     ...
     */
    public ItemSpiritGlowing setAlwaysEdible()
    {
