...
public class EntityWalnutShellElectric2 extends EntityThrowable
{
    public EntityWalnutShellElectric2(World par1World)
    {
        super(par1World);
    ...
    public EntityWalnutShellElectric2(World par1World, EntityPlayer par3EntityPlayer)
    {
        super(par1World, par3EntityPlayer);
    }

    public EntityWalnutShellElectric2(World par1World, double par2, double par4, double par6)
    {
