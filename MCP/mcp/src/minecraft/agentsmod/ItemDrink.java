...
public class ItemDrink extends ItemFood
{
    ...
    public ItemDrink(int par1, int par2, float par3, boolean par4)
    {
    ...
    public ItemDrink(int par1, int par2, boolean par3)
    {
    ...
    public ItemStack onEaten(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        if (par3EntityPlayer.getCurrentEquippedItem() != null && par3EntityPlayer.getCurrentEquippedItem().itemID == ModTools.poison.itemID)
        {
     ...
     */
    public ItemDrink setPotionEffect(int par1, int par2, int par3, float par4)
    {
        this.potionId = par1;
    ...
    public ItemDrink setPotionEffect2(int par1, int par2, int par3, float par4)
    {
        this.potionId2 = par1;
