...
public class BlockCropHops extends BlockCrops
{
    @SideOnly(Side.CLIENT)
    private Icon[] iconArray;
    
	protected BlockCropHops(int par1)
	{
		super(par1); 
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
	{
		...
		{
			par5EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ModFruits.hops,3));
    ...
    {
    	        return par1World.setBlockMetadataWithNotify(par2, par3, par4, 5, 2);
    }
    
	public void fertilize(World par1World, int par2, int par3, int par4)
    {
        int l = par1World.getBlockMetadata(par2, par3, par4) + MathHelper.getRandomIntegerInRange(par1World.rand, 1, 1);
    ...
    {
        return par1 == Block.grass.blockID || par1 == Block.dirt.blockID || par1 == Block.tilledField.blockID|| par1 == ModCrops.hopsCrop.blockID;
    }
	...
	{
		return ModFruits.hopSeed.itemID;
	}
		...
		if (ii == 5)
		{
			if (par1World.isAirBlock(par2, par3 + 1, par4)) //If the top block is air
			{
				...
				if (var6 < 2)
				{
					...
					if (var7 == 5) //If the metadata is _ _ _
					{
