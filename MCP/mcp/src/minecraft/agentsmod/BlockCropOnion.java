...
public class BlockCropOnion extends BlockCrops
 {
	...
	protected BlockCropOnion(int par1)
    {
        super(par1);
    ...
    {
    	        return par1World.setBlockMetadataWithNotify(par2, par3, par4, 4, 2);
    }
...
public int quantityDropped(Random par1Random)
{
	...
	//public boolean onRightClick(World par1World, int par2, int par3, int par4, World world, int i, int j, int k, EntityPlayer entityplayer)
	//{
			//EntityItem entityitem = new EntityItem(world, i, j, k, new ItemStack(ModFruits.onion, 2));
