...
public class BlockCigarboxC4 extends Block
{
    ...
    protected BlockCigarboxC4(int par1, Material wood)
    {
    ...
    {
        return par1 == 1 ? this.blockTop : par1 == 0 ? this.blockBottom : par1 == 5 ? this.blockFront : par1 == 4 ? this.blockBack : this.blockIcon;
    }
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
		if (par5EntityPlayer.getCurrentEquippedItem() != null && par5EntityPlayer.getCurrentEquippedItem().itemID == ModFruits.tobaccoCigar.itemID)
		{
			...
			par1World.setBlock(par2, par3, par4, ModBlocks.cigarbox3e.blockID);
			return false;
		}
		...
		else
		{
			...
			this.onBlockDestroyedByPlayer(par1World, par2, par3, par4, 1);
			par1World.setBlock(par2, par3, par4, ModBlocks.cigarbox3c.blockID);
