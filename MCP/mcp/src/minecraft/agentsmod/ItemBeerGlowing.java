...
public class ItemBeerGlowing extends ItemFood
{
    ...
    public ItemBeerGlowing(int par1, int par2, float par3, boolean par4)
    {
    ...
    public ItemBeerGlowing(int par1, int par2, boolean par3)
    {
    ...
    public ItemStack onEaten(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ModFood.tankard,1));
     ...
     */
    public ItemBeerGlowing setPotionEffect(int par1, int par2, int par3, float par4)
    {
        this.potionId = par1;
    ...
    public ItemBeerGlowing setPotionEffect2(int par1, int par2, int par3, float par4)
    {
        this.potionId2 = par1;
    ...
    public ItemBeerGlowing setPotionEffect3(int par1, int par2, int par3, float par4)
    {
        this.potionId3 = par1;
    ...
    public ItemBeerGlowing setPotionEffect4(int par1, int par2, int par3, float par4)
    {
        this.potionId4 = par1;
    ...
    public ItemBeerGlowing setPotionEffect5(int par1, int par2, int par3, float par4)
    {
        this.potionId5 = par1;
    ...
    public ItemBeerGlowing setPotionEffect6(int par1, int par2, int par3, float par4)
    {
        this.potionId6 = par1;
     ...
     */
    public ItemBeerGlowing setAlwaysEdible()
    {
