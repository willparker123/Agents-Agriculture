...
public class ItemFoodPackaged extends ItemFood
{
    ...
    public ItemFoodPackaged(int par1, int par2, float par3, boolean par4)
    {
    ...
    public ItemFoodPackaged(int par1, int par2, boolean par3)
    {
    ...
    public ItemStack onEaten(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ModFood.pack,1));
        
        if (par3EntityPlayer.getCurrentEquippedItem() != null && par3EntityPlayer.getCurrentEquippedItem().itemID == ModFood.pack.itemID)
        {
     ...
     */
    public ItemFoodPackaged setPotionEffect(int par1, int par2, int par3, float par4)
    {
        this.potionId = par1;
    ...
    public ItemFoodPackaged setPotionEffect2(int par1, int par2, int par3, float par4)
    {
        this.potionId2 = par1;
     ...
     */
    public ItemFoodPackaged setAlwaysEdible()
    {
