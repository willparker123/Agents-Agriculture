...
public class BlockCropOats extends BlockCrops
{
	@SideOnly(Side.CLIENT)
	private Icon[] iconArray;


	protected BlockCropOats(int par1)
	{
		super(par1);
	...
	protected boolean canThisPlantGrowOnThisBlockID1(int par1)
	{
	...
	{
		int percent1 = par2Random.nextInt(100) + 1;
		int percent2 = par2Random.nextInt(100) + 1;

		if(percent1 <= 50)
		{	
			return ModFruits.oatsSeed.itemID;
		}
	...
	public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
	{
