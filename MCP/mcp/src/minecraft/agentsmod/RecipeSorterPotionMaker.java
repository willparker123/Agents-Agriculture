...
class RecipeSorterPotionMaker implements Comparator
{
    final CraftingManagerPotionMaker craftingManager;

    RecipeSorterPotionMaker(CraftingManagerPotionMaker par1CraftingManagerPotionMaker)
    {
        this.craftingManager = par1CraftingManagerPotionMaker;
    }
