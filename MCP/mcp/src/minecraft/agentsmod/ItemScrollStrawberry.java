...
public class ItemScrollStrawberry extends Item
 {
     public ItemScrollStrawberry(int i)
     {
         super(i);
         maxStackSize = 64;
     ...
     public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
     {
    	 ...
    	 par3EntityPlayer.addChatMessage("\2474Name: \247fStrawberry");
    	 ...
    	 par3EntityPlayer.addChatMessage("\247aDrops: \247f2-5 Strawberry");
    	 ...
    	 par3EntityPlayer.addChatMessage("Can be right-clicked for it's Fruit. Found in Forests");
    	 par3EntityPlayer.addChatMessage("\247l********************");
    	 }
