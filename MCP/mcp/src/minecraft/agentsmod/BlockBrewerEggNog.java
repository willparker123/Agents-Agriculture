...
public class BlockBrewerEggNog extends Block
{
	...
	public BlockBrewerEggNog(int par1, Material par2)
	{
	...
	public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
	{
		super.updateTick(par1World, par2, par3, par4, par5Random);
			...
			float f = 1.0F;
				...
				if (par5Random.nextInt((int)(80F / f) + 1) == 0)
				{
				    this.onBlockDestroyedByPlayer(par1World, par2, par3, par4, 1);
				    par1World.setBlock(par2, par3, par4, ModBlocks.brewerEggNogDone.blockID);
	            }
	    }
