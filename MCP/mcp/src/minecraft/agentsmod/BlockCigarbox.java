...
public class BlockCigarbox extends Block
{
    ...
    protected BlockCigarbox(int par1, Material wood)
    {
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLivingBase, ItemStack itemstack)
	{
		...
		if (l == 0)
		{
			...
			world.setBlock(x, y, z, ModBlocks.cigarbox4.blockID);
		}

		if (l == 1)
		{
			this.onBlockDestroyedByPlayer(world, x, y, z, 1);
			world.setBlock(x, y, z, ModBlocks.cigarbox3.blockID);
		}

		if (l == 2)
		{
			this.onBlockDestroyedByPlayer(world, x, y, z, 1);
			world.setBlock(x, y, z, ModBlocks.cigarbox2.blockID);
		}
