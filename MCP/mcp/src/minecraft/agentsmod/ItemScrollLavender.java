...
public class ItemScrollLavender extends Item
 {
     public ItemScrollLavender(int i)
     {
         super(i);
         maxStackSize = 64;
     ...
     public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
     {
    	 ...
    	 par3EntityPlayer.addChatMessage("\2474Name: \247fLavender");
    	 par3EntityPlayer.addChatMessage("\247aHeight: \247f1 Block");
    	 par3EntityPlayer.addChatMessage("\247aLight Level: \247fOver 11");
    	 par3EntityPlayer.addChatMessage("\247aStages: \247f6");
    	 par3EntityPlayer.addChatMessage("\247aDrops: \247f1-3 Lavender");
    	 ...
    	 par3EntityPlayer.addChatMessage("Found in Plains and Forests");
    	 par3EntityPlayer.addChatMessage("\247l********************");
    	 }
