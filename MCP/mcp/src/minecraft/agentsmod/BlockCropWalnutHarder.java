...
public class BlockCropWalnutHarder extends BlockCrops
{
    @SideOnly(Side.CLIENT)
    private Icon[] iconArray;
    
	protected BlockCropWalnutHarder(int par1)
	{
		super(par1);
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
	{
		...
		{
			par5EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ModFruits.walnutHarder,5));
    ...
    {
        int l = par1World.getBlockMetadata(par2, par3, par4) + MathHelper.getRandomIntegerInRange(par1World.rand, 1, 2); //Between 2-5 stages grown per bonemeal
	...
	public int idDropped(int par1, Random par2Random, int par3)
    {
        if (par1 >= 10)
        {
            return ModFruits.walnutHarder.itemID;
        }
        else
        {
            return 0;
