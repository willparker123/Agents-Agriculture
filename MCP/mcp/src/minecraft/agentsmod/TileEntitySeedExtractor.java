...
public class TileEntitySeedExtractor extends TileEntity implements ISidedInventory
{
	...
	public int furnaceSpeed = 300; //how many ticks to cook an item
	public int burnTime;
	...
	{
		return this.isInvNameLocalized() ? this.localisedName : "Seed Extractor";
	}
	...
	private static int getItemBurnTime(ItemStack itemstack)
	{
		...
		else
		{
			...
			if(item instanceof ItemBlock && Block.blocksList[i] != null)
			{
				...
				{
					return 21600; //ticks it burns for
				}

				if(block == ModFuels.organicfuelBlock2)
				{
					return 86400; //ticks it burns for
				}

				if(block == ModFuels.organicfuelBlock3)
				{
					return 345600; //ticks it burns for
				}
			}

			if (i == ModFuels.organicfuel.itemID) return 2400; //ticks it burns for
			if (i == ModFuels.organicfuel2.itemID) return 9600; //ticks it burns for
			if (i == ModFuels.organicfuel3.itemID) return 38400; //ticks it burns for
