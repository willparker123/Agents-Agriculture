...
public class ItemWine extends ItemFood
{
    ...
    public ItemWine(int par1, int par2, float par3, boolean par4)
    {
    ...
    public ItemWine(int par1, int par2, boolean par3)
    {
    ...
    public ItemStack onEaten(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        if (par3EntityPlayer.getCurrentEquippedItem() != null && par3EntityPlayer.getCurrentEquippedItem().itemID == ModFood.winebasic.itemID)
        {
        	par3EntityPlayer.heal(2);
        }
        
        if (par3EntityPlayer.getCurrentEquippedItem() != null && par3EntityPlayer.getCurrentEquippedItem().itemID == ModFood.winestrong.itemID)
        {
        	par3EntityPlayer.heal(4);
        }
        
        if (par3EntityPlayer.getCurrentEquippedItem() != null && par3EntityPlayer.getCurrentEquippedItem().itemID == ModFood.winered.itemID)
        {
        	par3EntityPlayer.heal(3);
        }
        
        if (par3EntityPlayer.getCurrentEquippedItem() != null && par3EntityPlayer.getCurrentEquippedItem().itemID == ModFood.winewhite.itemID)
        {
        	par3EntityPlayer.heal(3);
        }
        
        if (par3EntityPlayer.getCurrentEquippedItem() != null && par3EntityPlayer.getCurrentEquippedItem().itemID == ModFood.wineredstrong.itemID)
        {
        	par3EntityPlayer.heal(6);
        }
        
        if (par3EntityPlayer.getCurrentEquippedItem() != null && par3EntityPlayer.getCurrentEquippedItem().itemID == ModFood.winewhitestrong.itemID)
        {
        	par3EntityPlayer.heal(6);
        }
  
        par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ModFood.winecup,1));
     ...
     */
    public ItemWine setPotionEffect(int par1, int par2, int par3, float par4)
    {
        this.potionId = par1;
    ...
    public ItemWine setPotionEffect2(int par1, int par2, int par3, float par4)
    {
        this.potionId2 = par1;
    ...
    public ItemWine setPotionEffect3(int par1, int par2, int par3, float par4)
    {
        this.potionId3 = par1;
    ...
    public ItemWine setPotionEffect4(int par1, int par2, int par3, float par4)
    {
        this.potionId4 = par1;
    ...
    public ItemWine setPotionEffect5(int par1, int par2, int par3, float par4)
    {
        this.potionId5 = par1;
    ...
    public ItemWine setPotionEffect6(int par1, int par2, int par3, float par4)
    {
        this.potionId6 = par1;
     ...
     */
    public ItemWine setAlwaysEdible()
    {
