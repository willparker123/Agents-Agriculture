...
public class BlockDryingRackWeed extends BlockDirectional
{
	...
	public BlockDryingRackWeed(int par1, Material par2)
	{
...
{
    par5EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ModFruits.weed,4));
...
public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
{
	super.updateTick(par1World, par2, par3, par4, par5Random);
		...
		float f = 1.0F;
			...
			{
			    this.onBlockDestroyedByPlayer(par1World, par2, par3, par4, 1);
			    par1World.setBlock(par2, par3, par4, ModBlocks.rackWeedDry.blockID);
            }
        }
	/*/
	@SideOnly(Side.CLIENT)
...
/*/
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLivingBase, ItemStack itemstack)
	{
		...
		if (l == 1)
		{
			...
			world.setBlock(x, y, z, ModBlocks.rackWeedb.blockID);
		}
