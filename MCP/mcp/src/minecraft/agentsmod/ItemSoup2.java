...
public class ItemSoup2 extends ItemFood
{
    ...
    public ItemSoup2(int par1, int par2, float par3, boolean par4)
    {
    ...
    public ItemSoup2(int par1, int par2, boolean par3)
    {
     ...
     */
    public ItemSoup2 setPotionEffect(int par1, int par2, int par3, float par4)
    {
        this.potionId = par1;
    ...
    public ItemSoup2 setPotionEffect2(int par1, int par2, int par3, float par4)
    {
        this.potionId2 = par1;
     ...
     */
    public ItemSoup2 setAlwaysEdible()
    {
