...
public class BlockOrangeLeaves2 extends BlockLeavesBase implements IShearable
{
    ...
    protected BlockOrangeLeaves2(int par1)
    {
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
		...
		if (par1World.getBlockLightValue(par2, par3 + 1, par4) >= 8)
		{
	               ...
	               if (par5Random.nextInt((int)(350 / f) + 1) == 0)
				{
				    ...
				    par1World.setBlock(par2, par3, par4, ModCrops.orangeLeaves3.blockID);
				}
			}
