...
public class ItemFoodCereal extends ItemFood
{
    ...
    public ItemFoodCereal(int par1, int par2, float par3, boolean par4)
    {
    ...
    public ItemFoodCereal(int par1, int par2, boolean par3)
    {
     ...
     */
    public ItemFoodCereal setPotionEffect(int par1, int par2, int par3, float par4)
    {
        this.potionId = par1;
    ...
    public ItemFoodCereal setPotionEffect2(int par1, int par2, int par3, float par4)
    {
        this.potionId2 = par1;
     ...
     */
    public ItemFoodCereal setAlwaysEdible()
    {
