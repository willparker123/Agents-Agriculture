...
public class ItemScrollCarrot extends Item
 {
     public ItemScrollCarrot(int i)
     {
         super(i);
         maxStackSize = 64;
     ...
     public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
     {
    	 ...
    	 par3EntityPlayer.addChatMessage("\2474Name: \247fCarrot");
    	 ...
    	 par3EntityPlayer.addChatMessage("\247aDrops: \247f1-4 Carrots");
    	 ...
    	 par3EntityPlayer.addChatMessage("A Vanilla crop that can be used to breed Pigs.");
    	 par3EntityPlayer.addChatMessage("\247l********************");
    	 }
