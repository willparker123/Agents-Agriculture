...
public class BlockFermenter extends Block
{
	...
	public BlockFermenter(int par1, Material par2)
	{
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
	{
		if (par5EntityPlayer.getCurrentEquippedItem() != null && par5EntityPlayer.getCurrentEquippedItem().itemID == Item.bucketWater.itemID)
		{
			if (par5EntityPlayer.capabilities.isCreativeMode)
			{
				...
				par1World.setBlock(par2, par3, par4, ModBlocks.fermenterWater.blockID);
				return true;
			}
			else
			{
