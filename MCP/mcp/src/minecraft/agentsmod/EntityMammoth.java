...
public class EntityMammoth extends EntityAnimal
{
    ...
    public EntityMammoth(World par1World)
    {
		...
		this.targetTasks.addTask(8, new EntityAINearestAttackableTarget(this, EntityMammothZombie.class, 0, true));
		this.tasks.addTask(9, new EntityAIAttackOnCollide(this, EntityMammothZombie.class, 1.0D, true));
