...
public class ItemWalnutShellElectricCluster extends Item
 {
     public ItemWalnutShellElectricCluster(int i)
     {
         super(i);
         maxStackSize = 64;
     ...
     public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
     {
         ...
         if (!par2World.isRemote)
         {
             ...
             par2World.spawnEntityInWorld(new EntityWalnutShellElectric2(par2World, par3EntityPlayer));
             par2World.spawnEntityInWorld(new EntityWalnutShellElectric3(par2World, par3EntityPlayer));
