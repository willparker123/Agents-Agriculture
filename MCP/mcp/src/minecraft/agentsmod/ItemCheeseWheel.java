...
public class ItemCheeseWheel extends Item
{
    ...
    public ItemCheeseWheel(int par1)
    {
        super(par1);
    }
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int x, int y, int z, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
        	...
        	{
        		par3World.setBlock(x, y + 1, z, ModBlocks.blockcheesewheel.blockID);
        		par3World.notifyBlockOfNeighborChange(x, y, z, ModBlocks.blockcheesewheel.blockID);
