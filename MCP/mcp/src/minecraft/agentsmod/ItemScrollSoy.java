...
public class ItemScrollSoy extends Item
 {
     public ItemScrollSoy(int i)
     {
         super(i);
         maxStackSize = 64;
     ...
     public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
     {
    	 ...
    	 par3EntityPlayer.addChatMessage("\2474Name: \247fSoy Bean");
    	 ...
    	 par3EntityPlayer.addChatMessage("\247aDrops: \247f2-4 Soy Bean Pods");
    	 par3EntityPlayer.addChatMessage("\247aGrows On: \247fTilled Dirt");
    	 par3EntityPlayer.addChatMessage("\247aGrowth Rate: \247fMedium");
    	 par3EntityPlayer.addChatMessage("Has to be made with DNA to obtain. Can be right-clicked for its Fruit.");
    	 par3EntityPlayer.addChatMessage("\247l********************");
    	 }
