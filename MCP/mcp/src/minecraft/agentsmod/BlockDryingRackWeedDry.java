...
public class BlockDryingRackWeedDry extends BlockDirectional
{
	...
	public BlockDryingRackWeedDry(int par1, Material par2)
	{
...
{
    par5EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ModFruits.weedDry,4));
...
/*/
	...
	{
		return ModFruits.weedDry.itemID;
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLivingBase, ItemStack itemstack)
	{
		...
		if (l == 1)
		{
			...
			world.setBlock(x, y, z, ModBlocks.rackWeedDryb.blockID);
		}
