...
public class ItemScrollWalnutDiamond extends Item
 {
     public ItemScrollWalnutDiamond(int i)
     {
         super(i);
         maxStackSize = 64;
     ...
     public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
     {
    	 ...
    	 par3EntityPlayer.addChatMessage("\2474Name: \247fDiamond Walnut");
    	 ...
    	 par3EntityPlayer.addChatMessage("\247aDrops: \247f2-5 Diamond Walnuts");
    	 par3EntityPlayer.addChatMessage("\247aGrows On: \247fTilled Dirt");
    	 par3EntityPlayer.addChatMessage("\247aGrowth Rate: \247fMakes Tectonic Plates look fast");
