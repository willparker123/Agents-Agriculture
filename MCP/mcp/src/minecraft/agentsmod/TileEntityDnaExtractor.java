...
public class TileEntityDnaExtractor extends TileEntity implements ISidedInventory
{
	...
	public int furnaceSpeed = 50; //how many ticks to cook an item
	public int burnTime;
	...
	{
		return this.isInvNameLocalized() ? this.localisedName : "DNA Extractor";
	}
	...
	private boolean canSmelt()
	{
		...
		{
			ItemStack itemstack = DnaExtractorRecipes.smelting().getSmeltingResult(this.slots[0]);
	...
	public static int getItemBurnTime(ItemStack itemstack)
	{
		...
		else
		{
			...
			if(item instanceof ItemBlock && Block.blocksList[i] != null)
			{
				...
				{
					return 250; //ticks it burns for
				}

				if(block == ModFuels.organicfuelBlock2)
				{
					return 1000; //ticks it burns for
				}

				if(block == ModFuels.organicfuelBlock3)
				{
					return 4000; //ticks it burns for
				}
			}

			if (i == ModFuels.organicfuel.itemID) return 25; //ticks it burns for
			if (i == ModFuels.organicfuel2.itemID) return 100; //ticks it burns for
			if (i == ModFuels.organicfuel3.itemID) return 400; //ticks it burns for
