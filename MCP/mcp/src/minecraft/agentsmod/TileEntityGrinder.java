...
public class TileEntityGrinder extends TileEntity implements ISidedInventory
{
	...
	public int furnaceSpeed = 900; //how many ticks to cook an item
	public int burnTime;
	...
	{
		return this.isInvNameLocalized() ? this.localisedName : "Mill Stone";
	}
	...
	public void updateEntity()
	{
		...
		if(!this.worldObj.isRemote)
		{
			...
			{
				flag1 = true;
				BlockGrinder.updateGrinderBlockState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
			}
		}
	...
	private boolean canSmelt()
	{
		...
		{
			ItemStack itemstack = GrinderRecipes.smelting().getSmeltingResult(this.slots[0]);
	...
	public static int getItemBurnTime(ItemStack itemstack)
	{
		...
		else
		{
			...
			if (i == ModTools.stonecog.itemID) return 57600; //ticks it burns for
			if (i == ModTools.woodcog.itemID) return 28800; //ticks it burns for
