...
public class ItemScrollPumpkin extends Item
 {
     public ItemScrollPumpkin(int i)
     {
         super(i);
         maxStackSize = 64;
     ...
     public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
     {
    	 ...
    	 par3EntityPlayer.addChatMessage("\2474Name: \247fPumpkin");
    	 ...
    	 par3EntityPlayer.addChatMessage("\247aDrops: \247f1 Pumpkin");
    	 ...
    	 par3EntityPlayer.addChatMessage("Pumpkins can be worn as a hat.");
    	 par3EntityPlayer.addChatMessage("\247l********************");
    	 }
