...
public class ItemScrollCoffee extends Item
 {
     public ItemScrollCoffee(int i)
     {
         super(i);
         maxStackSize = 64;
     ...
     public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
     {
    	 ...
    	 par3EntityPlayer.addChatMessage("\2474Name: \247fCoffee");
    	 ...
    	 par3EntityPlayer.addChatMessage("\247aDrops: \247f4-6 Coffee Beans");
    	 par3EntityPlayer.addChatMessage("\247aGrows On: \247fTilled Dirt");
    	 par3EntityPlayer.addChatMessage("\247aGrowth Rate: \247fSlow");
    	 par3EntityPlayer.addChatMessage("Can be right-clicked for it's Fruit. Can only be obtained through DNA Cross-Breeding.");
    	 par3EntityPlayer.addChatMessage("\247l********************");
    	 }
