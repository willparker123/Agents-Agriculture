...
public class ItemScrollTomato extends Item
 {
     public ItemScrollTomato(int i)
     {
         super(i);
         maxStackSize = 64;
     ...
     public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
     {
    	 ...
    	 par3EntityPlayer.addChatMessage("\2474Name: \247fTomato");
    	 ...
    	 par3EntityPlayer.addChatMessage("\247aDrops: \247f2-4 Tomatoes");
    	 par3EntityPlayer.addChatMessage("\247aGrows On: \247fTilled Dirt");
    	 par3EntityPlayer.addChatMessage("\247aGrowth Rate: \247fMedium");
    	 par3EntityPlayer.addChatMessage("Can be right-clicked for it's Fruit. Found in Jungles, Forests and Swamps");
    	 par3EntityPlayer.addChatMessage("\247l********************");
    	 }
