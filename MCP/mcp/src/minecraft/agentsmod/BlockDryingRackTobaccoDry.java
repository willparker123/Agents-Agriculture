...
public class BlockDryingRackTobaccoDry extends BlockDirectional
{
	...
	public BlockDryingRackTobaccoDry(int par1, Material par2)
	{
...
{
    par5EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ModFruits.tobaccoDry,4));
...
/*/
	...
	{
		return ModFruits.tobaccoDry.itemID;
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLivingBase, ItemStack itemstack)
	{
		...
		if (l == 1)
		{
			...
			world.setBlock(x, y, z, ModBlocks.rackTobaccoDryb.blockID);
		}
