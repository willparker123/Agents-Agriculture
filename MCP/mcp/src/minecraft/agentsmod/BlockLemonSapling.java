...
public class BlockLemonSapling extends BlockFlower
{

        protected BlockLemonSapling(int i)
        {
                super(i);
                float f = 0.4F;
        ...
        public void updateTick(World world, int i, int j, int k, Random random)
        {
                ...
                if(world.getBlockLightValue(i, j + 1, k) >= 9 && random.nextInt(7) == 0)
                {
                        ...
                        {
                                growLemonTree(world, i, j, k, random);
                        }
                }
        }
        
        public void growLemonTree(World par1World, int par2, int par3, int par4, Random par5Random)
        {
            ...
            boolean var10 = false;
                ...
                var7 = new WorldGenLemonTree(true);
            ...
            if (!((WorldGenLemonTree)var7).generate(par1World, par5Random, par2 + var8, par3, par4 + var9))
            {
                if (var10)
                {
