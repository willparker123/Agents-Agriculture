...
public class ItemScrollOats extends Item
 {
     public ItemScrollOats(int i)
     {
         super(i);
         maxStackSize = 64;
     ...
     public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
     {
    	 ...
    	 par3EntityPlayer.addChatMessage("\2474Name: \247fOats");
    	 ...
    	 par3EntityPlayer.addChatMessage("\247aDrops: \247f4-6 Oats");
    	 ...
    	 par3EntityPlayer.addChatMessage("Can only be obtained through DNA Cross Breeding.");
    	 par3EntityPlayer.addChatMessage("\247l********************");
    	 }
