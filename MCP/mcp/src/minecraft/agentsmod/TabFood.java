...
public final class TabFood extends CreativeTabs
{
        public TabFood(int par1, String par2Str)
        {
                super(par1, par2Str);
        }
        ...
        public int getTabIconItemIndex()
        {
           //there is a diference between items and blocks. will give an example of both
                return ModFruits.corn.itemID;//items
        ...
        {
         return "\2472(Agent's Agriculture) Food + Fruits";
        }
}
