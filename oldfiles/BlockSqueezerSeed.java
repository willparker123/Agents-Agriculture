...
public class BlockSqueezerSeed extends Block
{
	@SideOnly(Side.CLIENT)
    private Icon blockTop;
	
    protected BlockSqueezerSeed(int par1, Material wood)
    {
    ...
    {
        	par5EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ModTools.oilseed,1));
