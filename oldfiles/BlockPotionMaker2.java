...
public class BlockPotionMaker2 extends Block
{
	...
	public BlockPotionMaker2(int par1, Material par2)
	{
	...
	{
		return par1 == 1 ? this.blockTop : par1 == 4 ? this.blockFront : this.blockIcon;
	}
