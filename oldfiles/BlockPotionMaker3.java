...
public class BlockPotionMaker3 extends Block
{
	...
	public BlockPotionMaker3(int par1, Material par2)
	{
	...
	{
		return par1 == 1 ? this.blockTop : par1 == 3 ? this.blockFront : this.blockIcon;
	}
