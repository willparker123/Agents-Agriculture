...
public class BlockSqueezerWhale extends Block
{
	@SideOnly(Side.CLIENT)
    private Icon blockTop;
	
    protected BlockSqueezerWhale(int par1, Material wood)
    {
    ...
    {
        	par5EntityPlayer.inventory.addItemStackToInventory(new ItemStack(ModTools.oilwhale,1));
